...
- 12 new groups cover known height, partial loads, payload, no-stack, oversize, allowed rotations, determinism, geometry/support invariants on 18 mixed orders, strict numeric validation, spreadsheet header/data integrity, API parity, HTTP/body/rate-limit behavior.
