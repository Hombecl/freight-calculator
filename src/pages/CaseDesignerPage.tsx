...
export default function CaseDesignerPage() {
  ...
  return <main className="max-w-7xl mx-auto px-4 py-10 space-y-6">
    ...
    <form onSubmit={e=>{e.preventDefault();void run();}} className="space-y-5">
